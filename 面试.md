...
4. 如果用hibernate学习起来比较费时间，而mybatis相对来说比较简单，也可以用springdata，但个人觉得springdata只适合单表。
5.  jpa是一种规范，hibernate也是遵从这种规范；  springDataJpa是对repository的封装，简化了repository的操作。 
